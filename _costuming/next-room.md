...
{% include flexgallery id="flexgallery1" caption="Images 1-3 from the Knox Theatre website, linked below"%}

{% include flexgallery id="flexgallery2" caption="Images 1-3 from the Knox Theatre website, linked below"%}
